...
function createReport(): BattlefieldPerformanceConsoleReport {
  return {
    ...
    monsterEntitiesEvaluatedTotal: 320,
    monsterPositionBytesUploadedTotal: 2_048_000,
    monsterPositionUploadCallsTotal: 40,
    ...
    snapshot: {
      ...
      environmentGeometryBytesAllocated: 1_048_576,
      environmentBuilderReplacements: 2,
      environmentSynchronizing: false,
      groundSynchronizing: false,
      monsterSlots: 220,
      aliveMonsters: 128,
      residentMonsters: 140,
      visibleMonsters: 72,
