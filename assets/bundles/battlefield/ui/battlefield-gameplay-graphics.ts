...
/**
 * 把双摇杆、临时操作按钮、玩家血条与武器弹药板压入同一个 Graphics 组件。
 *
...
export class BattlefieldGameplayGraphics {
  ...
  public synchronize(
    ...
    if (!frameChanged
      ...
      && interaction.graphicsRevision === this.interactionRevision
    ...
    interaction.draw(this.graphics);
    ...
    this.interactionRevision = interaction.graphicsRevision;
