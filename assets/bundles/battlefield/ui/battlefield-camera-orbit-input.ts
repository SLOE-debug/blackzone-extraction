...
/** 调用方复用的相机水平旋转像素增量。 */
export interface MutableBattlefieldCameraAzimuthDelta {
  x: number;
}

/** 从鼠标和摇杆之外的触摸区域收集水平旋转，纵向拖拽不会产生俯仰输入。 */
export class BattlefieldCameraOrbitInput {
  ...
  /** 取走本帧累计的水平像素增量，并清空内部缓冲。 */
  public consume(result: MutableBattlefieldCameraAzimuthDelta): void {
