...
export function createVehicleWreckMeshPlan(): BattlefieldEnvironmentMeshPlan {
  ...
  appendSkewedPrism(builder, WRECK_METAL, Object.freeze([
  ...
  appendSkewedPrism(builder, WRECK_RUST, Object.freeze([
  ...
  appendSkewedPrism(builder, WRECK_GLASS, Object.freeze([
  ...
  appendWheel(builder, -1.45, 0.56, -0.88, 467);
  appendWheel(builder, 1.52, 0.5, -0.78, 479);
  appendWheel(builder, -1.52, 0.58, 0.78, 487);
  appendWheel(builder, 1.42, 0.5, 0.86, 499);
  appendFacetedBlade(
    builder,
    WRECK_RUST,
    point(1.86, 1.0, -0.62),
...
function appendWheel(
  ...
  appendIrregularTube(builder, WRECK_DARK, Object.freeze([
