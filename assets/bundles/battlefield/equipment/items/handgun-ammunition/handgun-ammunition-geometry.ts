...
export function createFiftyActionExpressAmmunitionGeometry() {
...
/** 模块级复用的手枪弹药固定拓扑。 */
export const FIFTY_ACTION_EXPRESS_AMMUNITION_GEOMETRY =
  createFiftyActionExpressAmmunitionGeometry();
