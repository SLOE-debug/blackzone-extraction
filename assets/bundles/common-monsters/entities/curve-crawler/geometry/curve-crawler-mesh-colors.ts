...
const LEG_RED = 76 * COLOR_BYTE_SCALE;
const LEG_GREEN = 76 * COLOR_BYTE_SCALE;
const LEG_BLUE = 82 * COLOR_BYTE_SCALE;
const FOOT_RED = 66 * COLOR_BYTE_SCALE;
const FOOT_GREEN = 67 * COLOR_BYTE_SCALE;
const FOOT_BLUE = 72 * COLOR_BYTE_SCALE;
const ABDOMEN_RED = 92 * COLOR_BYTE_SCALE;
const ABDOMEN_GREEN = 91 * COLOR_BYTE_SCALE;
const ABDOMEN_BLUE = 98 * COLOR_BYTE_SCALE;
const THORAX_RED = 81 * COLOR_BYTE_SCALE;
const THORAX_GREEN = 80 * COLOR_BYTE_SCALE;
const THORAX_BLUE = 88 * COLOR_BYTE_SCALE;
const EYE_RED = 1;
