...
import { createLobbySpotlight } from './lobby-lighting';
...
export class LobbySceneRuntime {
  ...
  public initialize(): void {
    ...
    scene.globals.ambient.skyLightingColor = new Color(66, 9, 18, 255);
    scene.globals.ambient.groundLightingColor = new Color(35, 3, 9, 255);
    ...
    try {
      lobbyRenderer = new LobbyRenderer(runtimeRoot, this.surfaceMaterial);
      createLobbySpotlight(runtimeRoot);
